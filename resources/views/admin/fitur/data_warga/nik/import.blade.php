<form action="{{ route('data-warga.nik.import') }}" method="POST" enctype="multipart/form-data" id="form-import">
    @csrf
    ...
    <div class="mb-3">
        ...
        <a href="{{ asset('template_data_anggota.xlsx') }}"
            download
    ...
    <div>
        <label for="file_anggota" class="block text-sm font-medium mb-1">
            Pilih File
        </label>
        <input type="file"
            name="file_anggota"
        ...
        <p id="error-file_anggota" class="text-sm text-red-500 mt-1"></p>
    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        form.addEventListener("submit", async (e) => {
            ...
            const fileInput = document.getElementById("file_anggota");
            const errorFile = document.getElementById("error-file_anggota");
