                            ...
                            <div class="grid md:grid-cols-2 gap-4">
                                <div class="text-left">
                                    ...
                                    <input type="text" id="kelurahan_text"
                                        class="w-full text-sm border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 cursor-not-allowed" disabled>
...
<script>
    document.addEventListener("DOMContentLoaded", async () => {
        ...
        btnAddKK.addEventListener('click', () => {
            ...
            clone.removeAttribute('data-keluarga-id');

            const hiddenId = clone.querySelector('[name="id"]');
