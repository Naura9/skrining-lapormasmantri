<form action="{{ route('data-warga.kk.import') }}" method="POST" enctype="multipart/form-data" id="form-import">
    @csrf
    ...
    <div class="mb-3">
        ...
        <a href="{{ asset('template_data_keluarga.xlsx') }}"
            download
    ...
    <div>
        <label for="file_keluarga" class="block text-sm font-medium mb-1">
            Pilih File
        </label>
        <input type="file"
            name="file_keluarga"
        ...
        <p id="error-file_keluarga" class="text-sm text-red-500 mt-1"></p>
    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        form.addEventListener("submit", async (e) => {
            ...
            const fileInput = document.getElementById("file_keluarga");
            const errorFile = document.getElementById("error-file_keluarga");
            ...
            try {
                ...
                if (data.status) {
                    ...
                    document.getElementById("importKeluargaModal")
